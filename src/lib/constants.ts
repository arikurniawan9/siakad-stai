...
export const sidebarItems: SidebarItem[] = [
  ...
  { href: "/dashboard/master-data", label: "Master Data", roles: ["Admin", "Prodi", "Staff"] },
  { href: "/dashboard/pmb", label: "PMB", roles: ["Admin", "Prodi", "Staff"] },
  { href: "/dashboard/registrasi", label: "Registrasi", roles: ["Admin", "Staff", "Keuangan", "Mahasiswa"] },
  { href: "/dashboard/krs", label: "KRS", roles: ["Admin", "Prodi", "Dosen", "Mahasiswa"] },
  { href: "/dashboard/nilai", label: "Nilai", roles: ["Admin", "Prodi", "Dosen", "Mahasiswa"] },
  { href: "/dashboard/keuangan", label: "Keuangan", roles: ["Admin", "Keuangan", "Mahasiswa", "Pimpinan"] },
  { href: "/dashboard/laporan", label: "Laporan", roles: ["Admin", "Prodi", "Keuangan", "Pimpinan"] },
];
